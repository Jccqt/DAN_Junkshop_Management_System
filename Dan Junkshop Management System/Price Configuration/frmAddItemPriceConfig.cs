        ...
        private void btnAddItem_Click(object sender, EventArgs e)
        {
            ...
            if(saveIndicator && !alreadyExisting)
            {
                ...
                if(saveItemClass == DialogResult.Yes)
                {
                    ...
                    ConnectionObjects.cmd = new SqlCommand("INSERT INTO ItemClass VALUES(@itemclassid, @itemclassname, @itemclassplantprice, @itemclasscapital)", ConnectionObjects.conn);
