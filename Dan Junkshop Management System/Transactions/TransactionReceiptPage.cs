...
{
    public partial class TransactionReceiptPage : Form
    {
        ...
        private void TransactionReceiptPage_Load(object sender, EventArgs e)
        {
            ...
            ConnectionObjects.cmd.Parameters.AddWithValue("@transactionid", PageObjects.newBuyTransaction.TransactionID.Text);
            ...
            if (ConnectionObjects.reader.Read())
            {
                receiptDetails.Add(new TransactionReceipt
                {
                    ...
                    TransactionID = PageObjects.newBuyTransaction.TransactionID.Text,
